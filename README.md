...
````
# Define the menu
starters = ["Garlic Bread", "Caesar Salad", "Mozzarella Sticks", "Bruschetta", "Soup of the Day"]
mains = ["Pizza", "Burger", "Spaghetti Bolognese", "Fish and Chips", "Roast Chicken"]
...
````
# say the customer's order back to them
print("Your order:")
